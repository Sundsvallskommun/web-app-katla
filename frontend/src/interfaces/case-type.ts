...
export const getCaseLabels = (): Record<FTCaseType, string> => ({
  ...
  [FTCaseType.PARATRANSIT_NOTIFICATION_REASSESSMENT]: FTCaseLabel.PARATRANSIT_NOTIFICATION_REASSESSMENT,
...
export const getCaseShortLabels = (): Record<FTCaseType, string> => ({
  ...
  [FTCaseType.PARATRANSIT_NOTIFICATION_CHANGE]: 'Anmälan förändring',
  [FTCaseType.PARATRANSIT_NOTIFICATION_REASSESSMENT]: 'Anmälan omprövning',
